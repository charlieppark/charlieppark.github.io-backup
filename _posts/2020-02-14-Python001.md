---
layout: post
title:  UDP 통신 기반 Parametric Body 구현 on Windows 10 (UDP Protocol based Parametric Body Estimation On Windows 10)
tags: [Python,Unity,Body-Estimation]
image: /img/post/PYTHON/title001.png
bigimg: /img/bg/PYTHON/bg001.png
comments: true
---

UDP 메세지로 조작할 수 있는 Python 기반의 SCAPE Body Estimation 프로그램을 만들고 예제를 만든다. 참고 자료는 https://github.com/KimYC1223/3D-Body-Estimation 에 첨부하였다.
