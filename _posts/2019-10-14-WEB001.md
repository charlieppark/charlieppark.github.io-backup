...
<iframe width="100%" height="300" src="//jsfiddle.net/kimyc1223/du3brtfj/15/embedded/result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
body {
  background: linear-gradient(75deg,#81ecec,#6c5ce7);
}
